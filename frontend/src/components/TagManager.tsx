        ...
        <div className="space-y-4">
            ...
            <form onSubmit={handleAddTag} className="flex gap-2">
                <input
                    ...
                    className="flex-1 px-3 py-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-sm outline-none focus:ring-2 focus:ring-violet-500 dark:text-white"
                />
                <button
                    type="submit"
                    disabled={!newTagName.trim()}
                    className="px-4 py-2 bg-violet-500 text-white rounded-lg text-sm font-medium hover:bg-violet-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                >
